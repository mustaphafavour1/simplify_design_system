...
const STATIC = {
  ...
  status: 'delivered',
  meta: [{key:"Type",value:"Web Portal (Enterprise)"},{key:"Client",value:"Office of the Accountant General of the Federation (OAGF)"},{key:"Audience",value:"Government finance officers, treasury managers, MDA staff"},{key:"Built by",value:"Simplify Synergy"}],
  features: [{iconName:"ArrowsLeftRight",title:"Payment Management",description:"Manage and track government payment flows across ministries and agencies."},{iconName:"ChartBar",title:"Treasury Analytics",description:"Real-time dashboards for cash position, inflows, outflows, and forecasting."},{iconName:"Table",title:"Transaction Reporting",description:"Detailed transaction logs with export to PDF, XLSX, HTML, and CSV."},{iconName:"ShieldCheck",title:"Compliance Controls",description:"Built-in audit trails and approval workflows for regulatory compliance."},{iconName:"Users",title:"Multi-agency Access",description:"Role-based access for multiple MDAs."},{iconName:"FileText",title:"Reconciliation",description:"Automated reconciliation of government accounts against transaction records."}],
  colours: [{name:"OAGF Navy",hex:"#1E3A8A"},{name:"OAGF Blue",hex:"#1E40AF"},{name:"White",hex:"#FFFFFF"}],
...
export default async function ProductPage() {
  ...
  return (
    <div>
          ...
          <div className="prod-logo-block" style={{ background:'linear-gradient(135deg,#1E3A8A,#1E40AF)' }}>
            {d.logo
              ...
              : <div className="prod-logo-ph">
                  <span style={{ color:'white', fontSize:18, fontWeight:800, textAlign:'center' }}>OAGF Treasury Portal</span>
      ...
      <section className="prod-section">
        <h2 className="prod-section-title">What OAGF Treasury Portal does</h2>
