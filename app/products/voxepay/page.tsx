...
const STATIC = {
  ...
  description: "VoxePay is Simplify Synergy's payment gateway — enabling individuals to pay bills and transfer money, businesses to collect payments and reconcile transactions, and developers to integrate payment capabilities via API.",
    ...
    <div>
      ...
      <section className="prod-section">
        <div className="prod-identity-row">
          <div className="prod-logo-block" style={{ background:'linear-gradient(135deg,#1B56F4,#0D1B4B)' }}>
            {d.logo
              ? <Image src={urlFor(d.logo).width(200).url()} alt="VoxePay" width={160} height={48} style={{ objectFit:'contain' }} />
              : <div className="prod-logo-ph">
                  <span style={{ color:'white', fontSize:22, fontWeight:800 }}>VoxePay</span>
      ...
      <section className="prod-section">
        <h2 className="prod-section-title">What VoxePay does</h2>
        ...
        <div className="prod-features-grid">
          {d.features.map((f: any) => (
            <div key={f.title} className="prod-feature-card">
              <div className="prod-feature-icon" style={{ background:'#EFF4FF' }}>
