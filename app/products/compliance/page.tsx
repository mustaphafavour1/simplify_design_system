...
const STATIC = {
  ...
  description: "An internal B2B platform for Simplify Synergy staff to manage compliance API integrations across all SS products — BVN verification, identity checks, KYC workflows, and user access control.",
  liveUrl: null as string | null,
  figmaUrl: null as string | null,
  status: 'internal',
  meta: [{key:"Type",value:"Internal web application"},{key:"Audience",value:"Simplify Synergy staff only"},{key:"Purpose",value:"Manage compliance APIs and KYC workflows"},{key:"Products",value:"Maestro MFB, VoxePay, and other SS subsidiaries"}],
  features: [{iconName:"PlugsConnected",title:"API Integrations",description:"Manage third-party compliance providers — BVN, NIN, CAC, AML screening."},{iconName:"Users",title:"User Management",description:"Create and manage users across subsidiaries. Assign roles and permissions."},{iconName:"ChartBar",title:"Costs & Usage",description:"Monitor API consumption and costs per product/subsidiary."},{iconName:"Gear",title:"Workflows",description:"Configure compliance workflows and automated processes."},{iconName:"ChartLine",title:"Analytics & Logs",description:"Audit trail of all compliance checks and API calls."},{iconName:"Buildings",title:"Multi-subsidiary",description:"Manage multiple SS products from a single dashboard."}],
  colours: [{name:"Compliance Purple",hex:"#6B52D9"},{name:"Navy",hex:"#1A1464"},{name:"White",hex:"#FFFFFF"}],
...
export default async function ProductPage() {
  ...
  return (
    <div>
      ...
      <section className="prod-section">
        <div className="prod-identity-row">
          <div className="prod-logo-block" style={{ background:'linear-gradient(135deg,#1A1464,#6B52D9)' }}>
            {d.logo
              ? <Image src={urlFor(d.logo).width(200).url()} alt="Simplify Compliance Engine" width={160} height={48} style={{ objectFit:'contain' }} />
              : <div className="prod-logo-ph">
                  <span style={{ color:'white', fontSize:18, fontWeight:800, textAlign:'center' }}>Simplify Compliance Engine</span>
      ...
      <section className="prod-section">
        <h2 className="prod-section-title">What Simplify Compliance Engine does</h2>
