import { v as operate, w as createOperatorSubscriber, c as compilerRuntimeExports, x as useWorkspace, r as reactExports, j as jsxRuntimeExports, E as ErrorBoundary, z as SourceProvider, D as setActivePanes, F as useTranslation, G as structureLocaleNamespace, I as SerializeError, S as Stack, T as Text, J as Code, m as Box, K as generateHelpUrl, f as yt, L as useRouter, M as useRouterState, g as useStructureTool, N as useDocumentStore, O as isRecord$4, C as Card, a as Container, H as Heading, B as Button, Q as SyncIcon, R as isHotkey, U as useToast, V as useSchema, W as useTheme, X as _isCustomDocumentTypeDefinition, Y as LoadingPane, Z as ResolvedPanesProvider, $ as StructureToolProvider, a0 as Flex, a1 as LOADING_PANE, a2 as StructureToolPane, a3 as StructureTitle, a4 as PortalProvider, a5 as map, a6 as v4, a7 as firstValueFrom, a8 as omit, a9 as ReplaySubject, aa as isObservable, ab as from, ac as switchMap, ad as of, ae as assignId, af as WarningOutlineIcon, ag as PaneLayout, ah as publishReplay, ai as refCount, aj as startWith, ak as isEqual, al as scan, am as NEVER, an as distinctUntilChanged, ao as concat } from "./sanity-DsmJfcEu.js";
function pairwise() {
...
const isPromise = (thing) => !!thing && typeof thing?.then == "function", isSerializable = (thing) => isRecord$4(thing) ? typeof thing.serialize == "function" : false, rethrowWithPaneResolutionErrors = (next) => (unresolvedPane, context, flatIndex) => {
  try {
...
function useRouterPanesStream() {
  const $ = compilerRuntimeExports.c(6), [routerStateSubject] = reactExports.useState(_temp$4);
  let t0;
  ...
  }, t2 = [routerState, routerStateSubject], $[2] = routerState, $[3] = routerStateSubject, $[4] = t1, $[5] = t2) : (t1 = $[4], t2 = $[5]), reactExports.useEffect(t1, t2), routerPanes$;
}
...
function useResolvedPanes() {
  const $ = compilerRuntimeExports.c(19), [error, setError] = reactExports.useState(), [maximizedPane, setMaximizedPane] = reactExports.useState(null);
  if (error)
    throw error;
  const {
    structureContext,
  ...
  const [data, setData] = reactExports.useState(t0), routerPanesStream = useRouterPanesStream();
  let t1, t2;
  ...
  }, t2 = [rootPaneNode, routerPanesStream, structureContext], $[1] = rootPaneNode, $[2] = routerPanesStream, $[3] = structureContext, $[4] = t1, $[5] = t2) : (t1 = $[4], t2 = $[5]), reactExports.useEffect(t1, t2);
  let t3, t4;
  ...
  }, t4 = [data, navigate], $[6] = data, $[7] = navigate, $[8] = t3, $[9] = t4) : (t3 = $[8], t4 = $[9]), reactExports.useEffect(t3, t4);
  let t5;
...
const EMPTY_RECORD = {}, IntentResolver = reactExports.memo(function() {
  const $ = compilerRuntimeExports.c(7), {
    ...
    rootPaneNode,
    structureContext
  } = useStructureTool(), documentStore = useDocumentStore(), [error, setError] = reactExports.useState(null);
  if (error)
    throw error;
  let t0, t1;
  ...
  }, t1 = [documentStore, maybeIntent, navigate, rootPaneNode, structureContext], $[0] = documentStore, $[1] = maybeIntent, $[2] = navigate, $[3] = rootPaneNode, $[4] = structureContext, $[5] = t0, $[6] = t1) : (t0 = $[5], t1 = $[6]), reactExports.useEffect(t0, t1), null;
});
...
const PathSegment = yt.span.withConfig({
...
function StructureError(t0) {
  const $ = compilerRuntimeExports.c(74), {
    error
  } = t0;
  ...
  if ($[4] !== cause || $[5] !== error.helpId || $[6] !== t) {
    ...
    let t152;
    $[25] !== t ? (t152 = t("structure-error.header.text"), $[25] = t, $[26] = t152) : t152 = $[26], $[27] !== t152 ? (t9 = /* @__PURE__ */ jsxRuntimeExports.jsx(Heading, { as: "h2", children: t152 }), $[27] = t152, $[28] = t9) : t9 = $[28], T0 = Card, t2 = 4, t3 = 4, t4 = 2, t5 = "auto", t6 = 1, t7 = "inherit", t8 = path.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { space: 2, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: 1, weight: "medium", children: t("structure-error.structure-path.label") }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Code, { children: path.slice(1).map(_temp2$2) })
  ...
  let t16;
  $[31] !== t15 ? (t16 = /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: 1, weight: "medium", children: t15 }), $[31] = t15, $[32] = t16) : t16 = $[32];
  let t17;
  ...
  let t18;
  $[37] !== t17 ? (t18 = /* @__PURE__ */ jsxRuntimeExports.jsx(Code, { children: t17 }), $[37] = t17, $[38] = t18) : t18 = $[38];
  let t19;
  $[39] !== t16 || $[40] !== t18 ? (t19 = /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { marginTop: 4, space: 2, children: [
    t16,
    t18
  ] }), $[39] = t16, $[40] = t18, $[41] = t19) : t19 = $[41];
  let t20;
  $[42] !== helpId || $[43] !== t ? (t20 = helpId && /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { marginTop: 4, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: generateHelpUrl(helpId), rel: "noopener noreferrer", target: "_blank", children: t("structure-error.docs-link.text") }) }) }), $[42] = helpId, $[43] = t, $[44] = t20) : t20 = $[44];
  let t21;
  $[45] !== t ? (t21 = t("structure-error.reload-button.text"), $[45] = t, $[46] = t21) : t21 = $[46];
  let t22;
  $[47] !== handleReload || $[48] !== t21 ? (t22 = /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { marginTop: 4, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { text: t21, icon: SyncIcon, tone: "primary", onClick: handleReload }) }), $[47] = handleReload, $[48] = t21, $[49] = t22) : t22 = $[49];
  let t23;
  $[50] !== T0 || $[51] !== t19 || $[52] !== t2 || $[53] !== t20 || $[54] !== t22 || $[55] !== t3 || $[56] !== t4 || $[57] !== t5 || $[58] !== t6 || $[59] !== t7 || $[60] !== t8 ? (t23 = /* @__PURE__ */ jsxRuntimeExports.jsxs(T0, { marginTop: t2, padding: t3, radius: t4, overflow: t5, shadow: t6, tone: t7, children: [
    t8,
    t19,
    t20,
    t22
  ...
  let t24;
  $[62] !== T1 || $[63] !== t23 || $[64] !== t9 ? (t24 = /* @__PURE__ */ jsxRuntimeExports.jsxs(T1, { children: [
    t9,
    t23
  ] }), $[62] = T1, $[63] = t23, $[64] = t9, $[65] = t24) : t24 = $[65];
  let t25;
  return $[66] !== T2 || $[67] !== t10 || $[68] !== t11 || $[69] !== t12 || $[70] !== t13 || $[71] !== t14 || $[72] !== t24 ? (t25 = /* @__PURE__ */ jsxRuntimeExports.jsx(T2, { height: t10, overflow: t11, padding: t12, sizing: t13, tone: t14, children: t24 }), $[66] = T2, $[67] = t10, $[68] = t11, $[69] = t12, $[70] = t13, $[71] = t14, $[72] = t24, $[73] = t25) : t25 = $[73], t25;
}
function _temp2$2(segment, i) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(PathSegment, { children: segment }, `${segment}-${i}`);
}
function _temp$2() {
...
function NoDocumentTypesScreen() {
  ...
  let t0;
  $[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t0 = /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: 1, children: /* @__PURE__ */ jsxRuntimeExports.jsx(WarningOutlineIcon, {}) }) }), $[0] = t0) : t0 = $[0];
  let t1;
  $[1] !== t ? (t1 = t("no-document-types-screen.title"), $[1] = t, $[2] = t1) : t1 = $[2];
  let t2;
  $[3] !== t1 ? (t2 = /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { as: "h1", size: 1, weight: "medium", children: t1 }), $[3] = t1, $[4] = t2) : t2 = $[4];
  let t3;
  $[5] !== t ? (t3 = t("no-document-types-screen.subtitle"), $[5] = t, $[6] = t3) : t3 = $[6];
  let t4;
  $[7] !== t3 ? (t4 = /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { as: "p", muted: true, size: 1, children: t3 }), $[7] = t3, $[8] = t4) : t4 = $[8];
  let t5;
  $[9] !== t ? (t5 = t("no-document-types-screen.link-text"), $[9] = t, $[10] = t5) : t5 = $[10];
  let t6;
  $[11] !== t5 ? (t6 = /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { as: "p", muted: true, size: 1, children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://www.sanity.io/docs/create-a-schema-and-configure-sanity-studio", target: "_blank", rel: "noreferrer", children: t5 }) }), $[11] = t5, $[12] = t6) : t6 = $[12];
  let t7;
  return $[13] !== t2 || $[14] !== t4 || $[15] !== t6 ? (t7 = /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { height: "fill", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Flex, { align: "center", height: "fill", justify: "center", padding: 4, sizing: "border", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Container, { width: 0, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { padding: 4, radius: 2, shadow: 1, tone: "caution", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Flex, { children: [
    t0,
...
const StyledPaneLayout = yt(PaneLayout).withConfig({
  displayName: "StyledPaneLayout",
  componentId: "sc-1hgaa0f-0"
})`min-height:100%;min-width:320px;`, isSaveHotkey = isHotkey("mod+s"), StructureTool = reactExports.memo(function(t0) {
  const $ = compilerRuntimeExports.c(58), {
    onPaneChange
  } = t0, {
    push: pushToast
    ...
    media
  } = t1, [portalElement, setPortalElement] = reactExports.useState(null);
  let t2;
  ...
  }, t6 = [onPaneChange, resolvedPanes], $[6] = onPaneChange, $[7] = resolvedPanes, $[8] = t5, $[9] = t6) : (t5 = $[8], t6 = $[9]), reactExports.useEffect(t5, t6);
  let t7, t8;
  $[10] !== pushToast ? (t7 = () => {
  ...
  }, t8 = [pushToast], $[10] = pushToast, $[11] = t7, $[12] = t8) : (t7 = $[11], t8 = $[12]), reactExports.useEffect(t7, t8);
  ...
  const onSetMaximizedPane = t9, previousSelectedIndexRef = reactExports.useRef(-1);
  let t10;
  ...
  let t12;
  $[22] !== navigate || $[23] !== paneDataItems || $[24] !== setMaximizedPane || $[25] !== t11 ? (t12 = [navigate, paneDataItems, t11, setMaximizedPane], $[22] = navigate, $[23] = paneDataItems, $[24] = setMaximizedPane, $[25] = t11, $[26] = t12) : t12 = $[26], reactExports.useEffect(t10, t12);
  let t13, t14;
  ...
  }, t14 = [maximizedPane, paneDataItems, setMaximizedPane], $[27] = maximizedPane, $[28] = paneDataItems, $[29] = setMaximizedPane, $[30] = t13, $[31] = t14) : (t13 = $[30], t14 = $[31]), reactExports.useEffect(t13, t14), !hasDefinedDocumentTypes) {
    let t152;
    return $[32] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t152 = /* @__PURE__ */ jsxRuntimeExports.jsx(NoDocumentTypesScreen, {}), $[32] = t152) : t152 = $[32], t152;
  }
  ...
  if ($[33] !== onSetMaximizedPane || $[34] !== paneItemsToShow) {
    ...
    $[36] !== onSetMaximizedPane ? (t192 = (paneData_0) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Fragment, { children: pane_5 === LOADING_PANE ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingPane, { paneKey, path, selected }) : /* @__PURE__ */ jsxRuntimeExports.jsx(StructureToolPane, { active, groupIndex, index: paneIndex, pane: pane_5, childItemId, itemId, paneKey, params: paneParams, payload, path, selected, siblingIndex, maximized, onSetMaximizedPane: () => onSetMaximizedPane(paneData_0) }) }, `${pane_5 === LOADING_PANE ? "loading" : pane_5.type}-${paneIndex}`);
    }, $[36] = onSetMaximizedPane, $[37] = t192) : t192 = $[37], t18 = paneItemsToShow.map(t192), $[33] = onSetMaximizedPane, $[34] = paneItemsToShow, $[35] = t18;
  } else
    t18 = $[35];
  let t19;
  $[38] !== isResolvingIntent || $[39] !== paneDataItems.length ? (t19 = paneDataItems.length <= 1 && isResolvingIntent && /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingPane, { paneKey: "intent-resolver" }), $[38] = isResolvingIntent, $[39] = paneDataItems.length, $[40] = t19) : t19 = $[40];
  let t20;
  $[41] !== handleRootCollapse || $[42] !== handleRootExpand || $[43] !== media[1] || $[44] !== t16 || $[45] !== t18 || $[46] !== t19 ? (t20 = /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledPaneLayout, { flex: 1, height: t16, minWidth: t17, onCollapse: handleRootCollapse, onExpand: handleRootExpand, children: [
    t18,
    t19
  ] }), $[41] = handleRootCollapse, $[42] = handleRootExpand, $[43] = media[1], $[44] = t16, $[45] = t18, $[46] = t19, $[47] = t20) : t20 = $[47];
  let t21;
  $[48] !== resolvedPanes ? (t21 = /* @__PURE__ */ jsxRuntimeExports.jsx(StructureTitle, { resolvedPanes }), $[48] = resolvedPanes, $[49] = t21) : t21 = $[49];
  let t22;
  $[50] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t22 = /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-portal": "", ref: setPortalElement }), $[50] = t22) : t22 = $[50];
  let t23;
  $[51] !== t15 || $[52] !== t20 || $[53] !== t21 ? (t23 = /* @__PURE__ */ jsxRuntimeExports.jsxs(PortalProvider, { element: t15, children: [
    t20,
    t21,
    t22
  ] }), $[51] = t15, $[52] = t20, $[53] = t21, $[54] = t23) : t23 = $[54];
  let t24;
  return $[55] !== resolvedPanesValue || $[56] !== t23 ? (t24 = /* @__PURE__ */ jsxRuntimeExports.jsx(ResolvedPanesProvider, { value: resolvedPanesValue, children: t23 }), $[55] = resolvedPanesValue, $[56] = t23, $[57] = t24) : t24 = $[57], t24;
});
...
function StructureToolBoundary(t0) {
  ...
  let t3;
  $[2] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t3 = [], $[2] = t3) : t3 = $[2], reactExports.useEffect(_temp2, t3);
  let t4;
  $[3] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t4 = {
    error: null
  }, $[3] = t4) : t4 = $[3];
  const [t5, setError] = reactExports.useState(t4), {
    error
  } = t5;
  if (error) {
    let t62;
    return $[4] !== error ? (t62 = /* @__PURE__ */ jsxRuntimeExports.jsx(StructureError, { error }), $[4] = error, $[5] = t62) : t62 = $[5], t62;
  }
  const t6 = source || firstSource.name;
  let t7, t8;
  $[6] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t7 = /* @__PURE__ */ jsxRuntimeExports.jsx(StructureTool, { onPaneChange: setActivePanes }), t8 = /* @__PURE__ */ jsxRuntimeExports.jsx(IntentResolver, {}), $[6] = t7, $[7] = t8) : (t7 = $[6], t8 = $[7]);
  let t9;
  $[8] !== defaultDocumentNode || $[9] !== structure ? (t9 = /* @__PURE__ */ jsxRuntimeExports.jsxs(StructureToolProvider, { defaultDocumentNode, structure, children: [
    t7,
    t8
  ] }), $[8] = defaultDocumentNode, $[9] = structure, $[10] = t9) : t9 = $[10];
  let t10;
  return $[11] !== t6 || $[12] !== t9 ? (t10 = /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorBoundary, { onCatch: setError, children: /* @__PURE__ */ jsxRuntimeExports.jsx(SourceProvider, { name: t6, children: t9 }) }), $[11] = t6, $[12] = t9, $[13] = t10) : t10 = $[13], t10;
}
function _temp2() {
