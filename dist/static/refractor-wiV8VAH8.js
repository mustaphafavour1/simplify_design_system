import { aq as commonjsGlobal, ar as requireReact, ap as getDefaultExportFromCjs, b as distExports, j as jsxRuntimeExports } from "./sanity-DsmJfcEu.js";
var immutable;
...
function requireMapChildren() {
  ...
  mapChildren.depth = mapWithDepth;
  return mapChildren;
}
var convert_1;
...
var unistUtilFilter;
var hasRequiredUnistUtilFilter;
...
function requireMap() {
  ...
  hasRequiredMap = 1;
  map = typeof WeakMap === "function" ? HappyMap : SadMap;
  function HappyMap() {
    ...
    function addCopy(map2, node, ancestors) {
      ...
      ancestors.forEach(function(ancestor2) {
        if (!map2.has(ancestor2)) {
          map2.set(ancestor2, Object.assign({}, ancestor2, {
            children: []
          }));
          if (ancestor2 !== tree) {
...
function requireRefractor() {
  ...
  var React = requireReact();
  var fract = requireCore();
  var mapChildren2 = requireMapChildren();
  var addMarkers = requireAddMarkers();
  ...
  function Refractor2(props) {
    ...
    var value = ast.length === 0 ? props.value : ast.map(mapChildren2.depth(0));
